...
cd $HOME
wget -O vulkansdk-linux-x86_64-1.2.148.1.run https://vulkan.lunarg.com/sdk/download/1.2.148.1/linux/vulkansdk-linux-x86_64-1.2.148.1.run
chmod ugo+x vulkansdk-linux-x86_64-1.2.148.1.run
./vulkansdk-linux-x86_64-1.2.148.1.run
